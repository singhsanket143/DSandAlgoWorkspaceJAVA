...
public class Heap<T extends Comparable<T>> {
	...
	private HashMap<T, Integer> posmap;// for graph algo dijekstra
	...
	public void updatePriority(T value, int pidx) {
		int idx = -1;
		if (this.posmap.containsKey(idx)) {

		}
		pidx = (idx - 1) / 2;
		if (isLarger(pidx, idx)) {
			downHeapify(idx);
		} else {
			upHeapify(idx);
		}
