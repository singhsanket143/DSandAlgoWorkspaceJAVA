...
public class Q10 {
	...
	public static void main(String[] args) {
		...
		System.out.println(countChessPaths(N-1, N-1, 0, 0, mines, ports));
		printChessPaths(N-1, N-1, 0, 0, mines, ports, "");
		System.out.println(getChessPaths(N-1, N-1, 0, 0, mines, ports));
